...
const TicketSystem = () => {
  ...
  const TicketCard = ({ ticket }: { ticket: any }) => (
    <div
      ...
      className={`bg-white border-l-4 ${priorityConfig[ticket.priority as keyof typeof priorityConfig].borderColor} rounded-lg p-4 mb-3 cursor-pointer hover:shadow-lg transition-shadow duration-200`}
    >
      <div className="flex items-start justify-between">
        <h3 className="font-semibold text-gray-800 text-sm mb-2 flex-1">{ticket.title}</h3>
        <span className={`text-xs px-2 py-1 rounded-full ${priorityConfig[ticket.priority as keyof typeof priorityConfig].color} text-white font-medium ml-2`}>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="mt-1">
                        <span className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${priorityConfig[selectedTicket.priority as keyof typeof priorityConfig].color} text-white`}>
